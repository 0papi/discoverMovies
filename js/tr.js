...
const TOP_RATED_API_URL = 'https://api.themoviedb.org/3/movie/top_rated?api_key=11155205ddfd642006e9438183cf059b'
...
fetchTopRated(TOP_RATED_API_URL);

async function fetchTopRated(url) {
...
form.addEventListener('submit', (e) => {
  ...
  if(searchTerm && searchTerm !== '') {
    fetchTopRated(SEARCH_API + searchTerm);
    search.value = '';
  } else {
