...
const NOW_PLAYING_API_URL = 'https://api.themoviedb.org/3/movie/now_playing?api_key=11155205ddfd642006e9438183cf059b'



const SEARCH_API = 'https://api.themoviedb.org/3/search/movie?sort_by=now-playing.desc&api_key=11155205ddfd642006e9438183cf059b&query="'
...
fetchNowPlaying(NOW_PLAYING_API_URL);
...
form.addEventListener('submit', (e) => {
  ...
  if(searchTerm && searchTerm !== '') {
    fetchNowPlaying(SEARCH_API + searchTerm);
    search.value = '';
  } else {
